                            ...
                            @foreach ($products as $item)
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img style="height:280px" src="{{asset($item->image)}}" alt="">
                                        <div class="product-hover">
                                            <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            <a href="{{route("show",$item->id)}}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                                    </div>

                                    <h2 class="text-center"><a href="single-product.html">{{$item->name}}</a></h2>

                                    <div class="product-carousel-price">
                                        <h2 class="text-center"><a href="single-product.html">{{$item->brand_name}}</a></h2>
                                    </div>
                                </div>
                            @endforeach
